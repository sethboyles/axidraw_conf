...
x_travel_default = 12.00  # AxiDraw V2 and AxiDraw V3: X Carriage travel in inches.     Default: 300 mm = about 11.81 inches
y_travel_default = 9.00   # AxiDraw V2 and AxiDraw V3: Y Carriage travel in inches.     Default: 218 mm = about 8.58 inches
...
native_res_factor = 1327.0  # Motor resolution calculation factor, steps per inch, and used in conversions. Default: 1016.0
